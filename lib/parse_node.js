        ...
        if (prop.key && prop.value) {
            ...
            if (prop.value.type === 'Identifier') {
                ...
                if (b.type === 'FunctionDeclaration') {
                    ...
                    var calleeName = utils.getPropertyIfPresent(b, 'callee.name');
                    if (calleeName === 'require') {
                        var externalFilename = b.arguments[0].value;
                        // console.log(externalFile);
                        console.log(resolve(externalFilename, process.cwd(), ['my_app/src/entry']));

                    } else {
                        console.log('UNKNOWN CALL EXPRESSION: ' + calleeName);
                    }
