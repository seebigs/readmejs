...
function create (app, dest) {
    if (dest) {
        var templatePath = path.join(path.dirname(fs.realpathSync(__filename)), '../templates/html/');
        ...
        var data = {
            ...
            title: app.info.name + (app.info.version ? ' ' + app.info.version : '') + ' - documentation'
        };
